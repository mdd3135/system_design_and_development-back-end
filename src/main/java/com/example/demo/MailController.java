...
@Service
public class MailController implements MailService {
    
    private final Logger logger = (Logger) LoggerFactory.getLogger(MailController.class);

    private String from = "313521996@qq.com";
    ...
    public void mySendSimpleMail(String to, String subject, String content, JavaMailSender mailSender) {
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(to);//收信人
        message.setSubject(subject);//主题
        message.setText(content);//内容
    ...
    public void mysendHtmlMail(String to, String subject, String content, JavaMailSender mailSender) {
